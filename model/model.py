...
from .MSP import MultiScalePeriod
########################################################################################
...
class MRCNN_MSP(nn.Module):
    def __init__(self, afr_reduced_cnn_size):
        super(MRCNN_MSP, self).__init__()
        drate = 0.5
...
class AttnSleep(nn.Module):
    def __init__(self):
        ...
        # self.tce = TCE(Conformer(d_model=80, num_heads=4, num_layers=6, feed_forward_dim=1024, num_classes=num_classes), N)
...
if __name__ == '__main__':
    mrcnn = MRCNN(afr_reduced_cnn_size=30)
    out = mrcnn(torch.Tensor(128,1,3000))
    print(out.shape)